...
import { DARK_BACKGROUND, INACTIVE, LIGHT_BACKGROUND, LIGHT_ORANGE } from '../styles/colors';
...
const CustomInput = ({
    ...
    const theme = state.data.main.mode

    
    return (
        <View style={[styles.container, containerStyle, { borderColor: focus ? LIGHT_ORANGE : INACTIVE, borderWidth: 1 }]}>
                           ...
                           // onSubmitEditing={Keyboard.dismiss}
                            ...
                            style={[
                                styles.textInput,
                                {
                                    ...
                                    // color: focus ? TextInputColor : TextInputColor,
                                    color: theme == 'light' ? '#5F5F5F' : LIGHT_BACKGROUND,
                                },
